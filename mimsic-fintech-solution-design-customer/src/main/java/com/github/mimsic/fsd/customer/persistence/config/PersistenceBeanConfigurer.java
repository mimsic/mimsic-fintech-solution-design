package com.github.mimsic.fsd.customer.persistence.config;
...
@EnableJpaRepositories(
        basePackages = {
                "com.github.mimsic.fsd.customer.persistence.repository"
        },
...
public class PersistenceBeanConfigurer implements InitializingBean {
    ...
    private String[] entityPackages() {
        ...
        return new String[]{
                "com.github.mimsic.fsd.customer.persistence.entity"
        };
    }
